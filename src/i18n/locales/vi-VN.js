...
export default {
    ...
    dashboard: {
        ...
        welcomeNewUser: 'Xin chào {name}, chào mừng bạn.',
        welcomeBackUser: 'Xin chào {name}, chào mừng bạn quay lại.',
        announcement: 'Thông báo',
        siteAnnouncement: 'Thông báo trang web',
        subscriptionInfo: 'Thông tin gói đăng ký',
        planName: 'Tên gói đăng ký',
        expiryDate: 'Thời hạn hết hạn',
        planTraffic: 'Lưu lượng gói đăng ký',
        subscriptionQuotaUsed: 'Dung lượng gói đã dùng',
        subscriptionQuotaRemaining: 'Dung lượng gói còn lại',
        packageQuotaRemaining: 'Dung lượng gói mua thêm còn lại',
        trafficBoardTitle: 'Bảng lưu lượng',
        trafficBoardSubtitle: 'Tổng quan gói cước + gói mua thêm',
        packagePurchased: 'Đã mua gói lưu lượng',
        packageNotPurchased: 'Chưa mua gói lưu lượng',
        usagePanel: 'Bảng sử dụng',
        totalTrafficPackAndPackage: 'Tổng lưu lượng (gói đăng ký + mua thêm)',
        subscriptionMonthlyTraffic: 'Lưu lượng tháng của gói cước',
        trafficPackageQuota: 'Dung lượng gói lưu lượng',
        packageUsageNote: 'Khi lưu lượng gói chính dùng hết, hệ thống sẽ tự động sử dụng dung lượng gói lưu lượng mua thêm.',
        memberTier: 'Cấp bậc thành viên',
        tierPointsProgress: 'Điểm tăng trưởng {points} / {total}',
        tierCurrentPoints: 'Điểm hiện tại: {points}',
        tierNextLevel: 'Cấp bậc tiếp theo: {tier}',
        tierNeedPoints: 'Điểm cần thêm: {points}',
        nextTierHint: 'Cần thêm {points} điểm tăng trưởng để đạt {tier}',
        resetHint: 'Ngày reset: {day}',
        resetTimeLabel: 'Thời gian reset',
        purchaseTrafficPackage: 'Mua gói lưu lượng một lần',
        used: 'Đã dùng',
        todayTrafficTitle: 'Lưu lượng hôm nay',
        todayTrafficUsed: 'Đã dùng',
        todayTrafficUpload: 'Tải lên',
        todayTrafficDownload: 'Tải xuống',
        total: 'Tổng',
        remaining: 'Còn lại',
        ...
        none: 'Không có',
        days: 'ngày',
        noPlanPrompt: 'Bạn hiện tại không có gói đăng ký hợp lệ, vui lòng mua gói đăng ký để sử dụng dịch vụ',
        noPlanBadgePending: 'Chờ thanh toán',
        noPlanBadgeInactive: 'Chưa kích hoạt dịch vụ',
        noPlanTitlePending: 'Hoàn tất thanh toán để kích hoạt dịch vụ',
        noPlanTitleInactive: 'Chọn gói đăng ký và thanh toán để bắt đầu sử dụng',
        noPlanActionPending: 'Tiếp tục thanh toán',
        noPlanActionInactive: 'Tạo đơn ngay',
        importSubscription: 'Thêm cấu hình',
        purchasePlan: 'Mua gói đăng ký',
        ...
        renewPlan: 'Gia hạn gói đăng ký',
        noPlanToRenew: 'Không có gói đăng ký để gia hạn',
        resetTrafficConfirm: 'Xác nhận đặt lại lưu lượng',
        resetTrafficDesc: 'Thao tác này sẽ đặt lại lưu lượng đã sử dụng nhưng không tăng thời hạn gói đăng ký, có tiếp tục không?',
        resetTrafficSuccess: 'Tạo đơn hàng đặt lại lưu lượng thành công',
        resetTrafficWarning: 'Đặt lại chỉ ảnh hưởng đến lưu lượng đã sử dụng, không kéo dài thời hạn gói đăng ký',
        ...
        resetSecurity: 'Đặt lại địa chỉ cấu hình',
        resetSecurityTitle: 'Đặt lại địa chỉ cấu hình',
        confirmReset: 'Xác nhận đặt lại',
        resetSecurityConfirm: 'Bạn có chắc muốn đặt lại địa chỉ cấu hình không? Địa chỉ hiện tại sẽ mất hiệu lực, bạn cần thêm cấu hình mới để tiếp tục sử dụng.',
        ...
        scanQRCode: 'Quét mã QR để thêm cấu hình',
        scanQRCodeDesc: 'Dùng ứng dụng khách quét mã QR để thêm cấu hình',
        ...
        subscriptionCopied: 'Đã sao chép địa chỉ cấu hình vào clipboard',
        copyFailed: 'Sao chép thất bại, vui lòng sao chép thủ công',
        manualImportRequired: 'Không thể nhập tự động, vui lòng sao chép địa chỉ cấu hình thủ công để thêm',
        noSubscription: 'Không có địa chỉ cấu hình khả dụng',
        noClientsAvailable: 'Nền tảng này tạm thời không có cách nhập nhanh khả dụng',
        clientNotInstalled: 'Bạn chưa cài ứng dụng khách tương ứng, địa chỉ cấu hình đã được sao chép vào clipboard'
    },
    platforms: {
        ios: 'iOS',
        android: 'Android',
    ...
    myCenter: {
        ...
        accountBalance: 'Số dư tài khoản',
        financeTitle: 'Trung tâm tài chính',
        subscriptionPlanTitle: 'Gói đăng ký',
        levelBenefitsTitle: 'Quyền lợi cấp bậc',
        tabOverview: 'Tổng quan',
        tabSubscriptionPlan: 'Gói đăng ký',
        tabSecurity: 'Bảo mật',
        tabSettings: 'Cài đặt thông báo',
        ...
        accessPrivacy: 'Truy cập & quyền riêng tư',
        changeSubscription: 'Đổi gói đăng ký',
        billRecords: 'Lịch sử hóa đơn',
        passwordManagement: 'Password Management',
        passwordManagementDesc: 'Change login password to improve account security',
        redeemGiftCard: 'Đổi thẻ quà tặng',
        changePassword: 'Đổi mật khẩu',
        giftCardRuleTitle: 'Quy tắc đổi thẻ',
        giftCardRuleType1: 'Loại 1: Nạp số dư (value tính theo cent)',
        giftCardRuleType2: 'Loại 2: Gia hạn hiệu lực (value tính theo ngày)',
        giftCardRuleType3: 'Loại 3: Tăng dung lượng lưu lượng (value tính theo GB)',
        giftCardRuleType4: 'Loại 4: Xóa lưu lượng',
        giftCardRuleType5: 'Loại 5: Kích hoạt gói trực tiếp (value là số ngày, 0 là không hết hạn)',
        giftCardResultType1: 'Đã nạp số dư: {value}',
        giftCardResultType2: 'Đã gia hạn hiệu lực: {value} ngày',
        giftCardResultType3: 'Đã thêm lưu lượng: {value} GB',
        giftCardResultType4: 'Đã xóa lưu lượng',
        giftCardResultType5: 'Đã kích hoạt gói: {value} ngày',
        giftCardResultType5NoExpire: 'Đã kích hoạt gói không hết hạn',
        balanceDesc: 'Xem chi tiết số dư và lịch sử nạp tiền',
        orderHistory: 'Lịch sử đơn hàng',
        orderDesc: 'Xem đơn hàng trước đây và trạng thái thanh toán',
        referral: 'Hoa hồng giới thiệu',
        referralDesc: 'Xem tiến độ giới thiệu và chi tiết hoa hồng',
        settingsTitle: 'Cài đặt thông báo',
        expireReminder: 'Nhắc hết hạn',
        expireReminderDesc: 'Gửi email nhắc khi gói sắp hết hạn',
        trafficReminder: 'Nhắc lưu lượng',
        trafficReminderDesc: 'Gửi email nhắc khi lưu lượng sắp hết',
        securitySettings: 'Cài đặt bảo mật',
        securityDesc: 'Đổi mật khẩu và tùy chọn bảo mật tài khoản',
        securityCenterTitle: 'Trung tâm bảo mật',
        loginRecords: 'Phiên đang hoạt động',
        loginRecordsDesc: 'Quản lý các thiết bị và phiên đang đăng nhập',
        recentLoginTitle: 'Hoạt động đăng nhập gần đây',
        recentLoginDesc: 'Hiển thị 5 lần đăng nhập thành công gần nhất',
        loadingRecentLogin: 'Đang tải hoạt động đăng nhập gần đây...',
        recentLoginEmpty: 'Không có hoạt động đăng nhập gần đây',
        deviceReset: 'Đặt lại thiết bị',
        deviceResetDesc: 'Tạo lại cấu hình thiết bị và xóa ảnh hưởng của cấu hình cũ',
        sessionTitle: 'Quản lý phiên',
        sessionDesc: 'Đăng xuất phiên hiện tại, bạn có thể đăng nhập lại sau.',
        logout: 'Đăng xuất',
...
profile: {
        ...
        autoRenewalDesc: 'Tự động gia hạn gói đăng ký khi hết hạn',
        security: 'Cài đặt bảo mật',
        ...
        cancel: 'Hủy bỏ',
        noSubscription: 'Không có địa chỉ cấu hình khả dụng',
        getSubscription: 'Lấy địa chỉ cấu hình',
    ...
    shop: {
        ...
        no_plans_found: 'Không tìm thấy gói đăng ký phù hợp',
        try_different_filter: 'Vui lòng thử điều kiện lọc khác',
        reset_filter: 'Đặt lại bộ lọc',
        traffic_package: {
            entry: 'Mua gói lưu lượng',
            title: 'Mua gói lưu lượng',
            description: 'Chọn gói lưu lượng một lần. Sau khi mua sẽ được cộng ngay vào tài khoản.'
        },
        plan: {
            purchase: 'Mua',
            renew: 'Gia hạn',
            add_quota: 'Mua thêm lưu lượng',
            upgrade_to: 'Nâng cấp lên {name}',
            current: 'Gói hiện tại của bạn',
    ...
    order: {
        ...
        no_plan_selected: 'Chưa chọn gói đăng ký',
        plan_not_found: 'Gói đăng ký không tồn tại',
        failed_to_fetch_plan: 'Lấy thông tin gói đăng ký thất bại',
    ...
    profile: {
        ...
        confirmLogout: 'Xác nhận đăng xuất',
        logoutDesc: 'Bạn có chắc muốn đăng xuất không?',
        logout: 'Đăng xuất',
        ...
        logoutDeviceSuccess: 'Đã đăng xuất phiên thiết bị',
        logoutDeviceError: 'Không thể đăng xuất phiên thiết bị',
        noDevices: 'Không có lịch sử đăng nhập',
        unknownDevice: 'Thiết bị không xác định',
        unknownIP: 'IP không xác định',
        unknownBrowser: 'Trình duyệt không xác định',
        bindTelegram: 'Liên kết Telegram Bot',
        commandCopied: 'Đã sao chép lệnh vào clipboard',
        iKnow: 'Tôi đã hiểu',
        telegramError: 'Lấy thông tin Telegram thất bại',
