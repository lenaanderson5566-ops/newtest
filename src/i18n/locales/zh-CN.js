...
export default {
    ...
    dashboard: {
        ...
        aiSupportTitle: 'AI 工具支持',
        aiSupportSubtitle: '统一接入主流模型能力，按任务场景选择更合适的助手。',
        aiSupportClaudeDesc: '适合长文本理解、复杂推理与资料总结场景。',
        aiSupportChatgptDesc: '通用能力均衡，适合写作、问答和代码协作。',
        aiSupportGeminiDesc: '多模态能力更强，适合图文结合与信息检索。',
        aiSupportStatusReady: '已支持',
        aiSupportStatusBeta: '内测',
        aiSupportFeatureLongContext: '长上下文',
        aiSupportFeatureReasoning: '复杂推理',
        aiSupportFeatureSummarization: '文档总结',
        aiSupportFeatureAssistant: '通用助手',
        aiSupportFeatureCoding: '代码协作',
        aiSupportFeatureWorkflow: '流程自动化',
        aiSupportFeatureMultimodal: '多模态',
        aiSupportFeatureSearch: '检索增强',
        aiSupportFeatureAnalysis: '内容分析',
