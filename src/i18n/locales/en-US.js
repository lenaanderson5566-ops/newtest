...
export default {
    ...
    dashboard: {
        ...
        aiSupportTitle: 'AI Tools Support',
        aiSupportSubtitle: 'Use leading model ecosystems in one place and choose the best assistant by scenario.',
        aiSupportClaudeDesc: 'Best for long-context reading, deep reasoning, and document summarization.',
        aiSupportChatgptDesc: 'Balanced general capability for writing, Q&A, and coding collaboration.',
        aiSupportGeminiDesc: 'Stronger multimodal capability for mixed text-image understanding and search.',
        aiSupportStatusReady: 'Ready',
        aiSupportStatusBeta: 'Beta',
        aiSupportFeatureLongContext: 'Long Context',
        aiSupportFeatureReasoning: 'Reasoning',
        aiSupportFeatureSummarization: 'Summarization',
        aiSupportFeatureAssistant: 'General Assistant',
        aiSupportFeatureCoding: 'Coding',
        aiSupportFeatureWorkflow: 'Workflows',
        aiSupportFeatureMultimodal: 'Multimodal',
        aiSupportFeatureSearch: 'Search Enhanced',
        aiSupportFeatureAnalysis: 'Content Analysis',
