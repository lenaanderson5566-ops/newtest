...
export default {
  ...
  dashboard: {
    ...
    defaultUser: 'کاربر',
    welcomeNewUser: 'سلام {name}، خوش آمدید.',
    welcomeBackUser: 'سلام {name}، خوش برگشتید.',
    ...
    tierCurrentPoints: 'امتیاز فعلی: {points}',
    tierNextLevel: 'سطح بعدی: {tier}',
    tierNeedPoints: 'امتیاز موردنیاز: {points}',
    ...
    noPlanBadgePending: 'در انتظار پرداخت',
    noPlanBadgeInactive: 'سرویس فعال نشده',
    noPlanTitlePending: 'با تکمیل پرداخت، سرویس شما فعال می‌شود',
    noPlanTitleInactive: 'برای شروع، ابتدا اشتراک را انتخاب و پرداخت را تکمیل کنید',
    noPlanActionPending: 'ادامه پرداخت',
    noPlanActionInactive: 'ثبت سفارش',
    ...
    trafficPackageSupplementHint: 'برای مصرف فراتر از سقف پلن، از بسته ترافیک استفاده کنید.',
...
profile: {
  ...
  trafficLog: {
    ...
    emptyTitle: 'هنوز سابقه‌ای از مصرف وجود ندارد',
    emptyDesc: 'پس از شروع استفاده از سرویس، روند ترافیک اخیر در اینجا نمایش داده می‌شود.',
