...
export default {
  ...
  dashboard: {
    ...
    tierCurrentPoints: 'Текущие очки: {points}',
    tierNextLevel: 'Следующий уровень: {tier}',
    tierNeedPoints: 'Нужно очков: {points}',
    ...
    none: 'Нет',
    days: 'дней',
    noPlanPrompt: 'У вас нет активной подписки, приобретите подписку для использования сервиса',
    ...
    importSubscription: 'Добавить конфигурацию',
    ...
    renewPlan: 'Продлить подписку',
    noPlanToRenew: 'Нет подписки для продления',
    resetTrafficConfirm: 'Подтвердить сброс трафика',
    resetTrafficDesc: 'Это действие сбросит использованный трафик, но не продлит срок действия подпискаа. Продолжить?',
    resetTrafficSuccess: 'Заказ на сброс трафика успешно создан',
    resetTrafficWarning: 'Сброс влияет только на использованный трафик, не продлевает срок действия подпискаа',
    ...
    copySubscriptionDesc: 'Скопировать адрес конфигурации в буфер обмена',
    scanQRCode: 'Сканировать QR для добавления конфигурации',
    scanQRCodeDesc: 'Используйте клиент для сканирования QR-кода и добавления конфигурации',
    ...
    clientNotInstalled: 'Нужный клиент не установлен. Адрес конфигурации скопирован в буфер обмена.'
  },
  platforms: {
    ios: 'iOS',
    android: 'Android',
