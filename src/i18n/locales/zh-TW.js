...
export default {
  ...
  dashboard: {
    ...
    defaultUser: '用戶',
    welcomeNewUser: '你好，{name}，歡迎使用',
    welcomeBackUser: '你好，{name}，歡迎回來',
    announcement: '公告',
    ...
    usagePanel: '使用面板',
    totalTrafficPackAndPackage: '總流量（訂閱 + 流量包）',
    subscriptionMonthlyTraffic: '訂閱月流量',
    trafficPackageQuota: '流量包配額',
    packageUsageNote: '訂閱流量用完後，將自動使用流量額度包繼續使用。',
    memberTier: '會員等級',
    tierPointsProgress: '成長值 {points} / {total}',
    tierCurrentPoints: '當前成長值：{points}',
    tierNextLevel: '下一等級：{tier}',
    tierNeedPoints: '升級還需：{points}',
    nextTierHint: '距離 {tier} 還需 {points} 成長值',
    resetHint: '重置日：{day}',
    resetTimeLabel: '重置時間',
    purchaseTrafficPackage: '購買一次性流量包',
    used: '已用',
    todayTrafficTitle: '今日流量',
    todayTrafficUsed: '已使用',
    todayTrafficUpload: '上行',
    todayTrafficDownload: '下行',
    total: '總計',
    remaining: '剩餘',
    ...
    none: '無',
    days: '天',
    noPlanPrompt: '您目前沒有有效的訂閱，請購買訂閱以使用服務',
    noPlanBadgePending: '待完成付款',
    noPlanBadgeInactive: '未開通服務',
    noPlanTitlePending: '完成付款後即可啟用服務',
    noPlanTitleInactive: '先選擇訂閱並完成付款，即可開始使用',
    noPlanActionPending: '繼續付款',
    noPlanActionInactive: '立即下單',
    importSubscription: '新增配置',
    purchasePlan: '購買訂閱',
    resetTraffic: '重設流量',
    ...
    renewPlan: '續費訂閱',
    noPlanToRenew: '無可續費的訂閱',
    resetTrafficConfirm: '確認重設流量',
    resetTrafficDesc: '此操作將重設已使用的流量，但不增加訂閱時長，是否繼續？',
    resetTrafficSuccess: '成功建立重設流量訂單',
    resetTrafficWarning: '重設僅影響已使用流量，不延長訂閱有效期',
    ticketSupport: '工單支援',
    viewHelp: '檢視幫助',
    documentation: '使用文件',
    pendingItems: '待處理事項',
    ...
    copySubscriptionDesc: '複製配置地址到剪貼簿',
    scanQRCode: '掃描二維碼新增配置',
    scanQRCodeDesc: '使用客戶端掃描二維碼新增',
    ...
    subscriptionCopied: '配置地址已複製到剪貼簿',
    copyFailed: '複製失敗，請手動複製',
    manualImportRequired: '無法自動匯入，請手動複製配置地址進行新增',
    noSubscription: '暫無配置地址',
    noClientsAvailable: '此平台暫無可用快速匯入方式',
    clientNotInstalled: '您未安裝對應客戶端，已複製配置地址到剪貼簿'
  },
  platforms: {
    ios: 'iOS',
    android: 'Android',
  ...
  myCenter: {
    ...
    accountBalance: '帳戶餘額',
    financeTitle: '財務中心',
    subscriptionPlanTitle: '訂閱方案',
    levelBenefitsTitle: '等級權益',
    tabOverview: '總覽',
    tabSubscriptionPlan: '訂閱方案',
    tabSecurity: '安全性',
    tabSettings: '通知設定',
    tabLevelBenefits: '等級權益',
    tabInvite: '邀請返利',
        ...
        giftCardRuleType3: '類型 3：增加流量（value 單位：GB）',
        giftCardRuleType4: '類型 4：清空流量',
        giftCardRuleType5: '類型 5：直開方案（value 為天數，0 表示不過期）',
        giftCardResultType1: '已儲值餘額：{value}',
        giftCardResultType2: '已延長有效期：{value} 天',
        giftCardResultType3: '已增加流量：{value} GB',
        giftCardResultType4: '已清空流量',
        giftCardResultType5: '已開通方案：{value} 天',
        giftCardResultType5NoExpire: '已開通不過期方案',
    balanceDesc: '查看餘額明細與儲值紀錄',
    orderHistory: '訂單紀錄',
    orderDesc: '查看歷史訂單與支付狀態',
    referral: '邀請返利',
    referralDesc: '查看邀請進度與佣金明細',
    settingsTitle: '通知設定',
    expireReminder: '到期提醒',
    expireReminderDesc: '訂閱即將到期時發送郵件提醒',
    trafficReminder: '流量提醒',
    trafficReminderDesc: '流量不足時發送郵件提醒',
    securitySettings: '安全設定',
    securityDesc: '修改密碼與帳號安全選項',
    securityCenterTitle: '安全中心',
    loginRecords: '活躍會話',
    loginRecordsDesc: '管理目前已登入的裝置與會話',
    recentLoginTitle: '最近登入資訊',
    recentLoginDesc: '顯示最近 5 次成功登入記錄',
    loadingRecentLogin: '正在載入最近登入記錄...',
    recentLoginEmpty: '暫無最近登入記錄',
    deviceReset: '裝置重置',
    deviceResetDesc: '重新產生裝置設定，清除舊設定影響',
    sessionTitle: '會話操作',
    sessionDesc: '登出目前登入會話，稍後可重新登入。',
    logout: '登出',
...
profile: {
    ...
    confirmReset: '確認重置',
    resetSecurityConfirm: '確定要重置配置地址嗎？目前配置地址將失效，需要重新新增新的配置才能繼續使用。',
    resetSuccess: '重設成功',
    resetError: '重設失敗',
    copySubscription: '複製配置地址',
    subscriptionCopied: '配置地址已複製到剪貼簿',
    ...
    sessionError: '取得登入記錄失敗',
        logoutAllSessions: '退出全部會話',
        loggingOutAllSessions: '正在退出全部會話...',
        logoutAllSessionsSuccess: '已退出全部會話',
        logoutAllSessionsError: '退出全部會話失敗',
        logoutDevice: '註銷',
        loggingOutDevice: '註銷中...',
        logoutDeviceSuccess: '裝置會話已註銷',
        logoutDeviceError: '註銷裝置會話失敗',
  ...
  order: {
    ...
    order_failed: '訂單建立失敗',
    no_plan_selected: '未選擇訂閱',
    plan_not_found: '訂閱不存在',
    failed_to_fetch_plan: '取得訂閱資訊失敗',
    confirm_order_title: '確認訂單',
    confirm_purchase: '確認購買'
  },
  payment: {
  ...
  invite: {
    ...
    inviteLink: {
      ...
      copyLink: '複製連結',
      copied: '已複製',
      noInviteCode: '暫無可用邀請連結',
      created: '邀請連結建立成功，可分享給好友'
    },
    share: {
      wechat: '微信',
      qq: 'QQ',
    ...
    records: {
      ...
      amount: '消費金額',
      userPlaceholder: '用戶',
      noRecords: '您尚未有邀請記錄，建立邀請連結並分享給朋友吧！',
      refresh: '重新整理',
      refreshing: '重新整理中...',
  ...
  docs: {
    ...
    noAccessPrompt: '您目前沒有有效的訂閱，購買訂閱後即可檢視該區域的內容',
    loading: '正在載入文件...',
    retry: '重試',
    clearSearch: '清除搜尋',
    backToList: '返回文件列表',
