...
export default {
  ...
  dashboard: {
    ...
    defaultUser: '사용자',
    welcomeNewUser: '안녕하세요, {name}님. 환영합니다.',
    welcomeBackUser: '안녕하세요, {name}님. 다시 오신 것을 환영합니다.',
    announcement: '공지',
    ...
    tierCurrentPoints: '현재 성장 포인트: {points}',
    tierNextLevel: '다음 등급: {tier}',
    tierNeedPoints: '필요 포인트: {points}',
    nextTierHint: '{tier} 등급까지 {points} 성장 포인트 필요',
    resetHint: '리셋일: {day}',
    resetTimeLabel: '리셋 시간',
    purchaseTrafficPackage: '일회성 트래픽 패키지 구매',
    used: '사용됨',
    todayTrafficTitle: '오늘 트래픽',
    todayTrafficUsed: '사용됨',
    todayTrafficUpload: '업로드',
    todayTrafficDownload: '다운로드',
    total: '총합',
    remaining: '남음',
    ...
    none: '없음',
    days: '일',
    noPlanPrompt: '현재 유효한 구독이 없습니다. 구독을 구매하여 서비스를 이용하세요',
    noPlanBadgePending: '결제 대기',
    noPlanBadgeInactive: '서비스 미개통',
    noPlanTitlePending: '결제를 완료하면 서비스를 활성화할 수 있습니다',
    noPlanTitleInactive: '구독을 선택하고 결제를 완료하면 바로 시작할 수 있습니다',
    noPlanActionPending: '결제 계속',
    noPlanActionInactive: '지금 주문',
    importSubscription: '구성 추가',
    purchasePlan: '구독 구매',
    ...
    renewPlan: '구독 갱신',
    noPlanToRenew: '갱신 가능한 구독 없음',
    resetTrafficConfirm: '트래픽 초기화 확인',
    resetTrafficDesc: '이 작업은 사용된 트래픽을 초기화하지만 구독 기간은 연장되지 않습니다. 계속하시겠습니까?',
    resetTrafficSuccess: '트래픽 초기화 주문 생성 성공',
    resetTrafficWarning: '초기화는 사용된 트래픽에만 영향을 미치며 구독 유효 기간을 연장하지 않습니다',
    ticketSupport: '티켓 지원',
    viewHelp: '도움말 보기',
    documentation: '사용 문서',
    ...
    planAction: {
      ...
      restoreNow: '지금 복구',
      renewNow: '지금 갱신',
      reselectPlan: '구독 다시 선택',
      renew: '갱신'
    },
    
    importTitle: '가져오기 방식 선택',
    copySubscription: '구성 주소 복사',
    copySubscriptionDesc: '구성 주소를 클립보드에 복사',
    scanQRCode: 'QR 코드로 구성 추가',
    scanQRCodeDesc: '클라이언트로 QR 코드를 스캔해 구성 추가',
    ...
    subscriptionCopied: '구성 주소가 클립보드에 복사되었습니다',
    copyFailed: '복사 실패, 수동으로 복사하세요',
    manualImportRequired: '자동 가져오기를 사용할 수 없습니다. 구성 주소를 수동으로 복사해 추가하세요',
    noSubscription: '사용 가능한 구성 주소가 없습니다',
    noClientsAvailable: '이 플랫폼은 빠른 가져오기 방법을 지원하지 않습니다',
    clientNotInstalled: '해당 클라이언트가 설치되어 있지 않아 구성 주소를 클립보드에 복사했습니다'
  },
  platforms: {
    ios: 'iOS',
    android: 'Android',
  ...
  myCenter: {
    ...
    accountBalance: '계정 잔액',
    financeTitle: '재무 센터',
    subscriptionPlanTitle: '구독 플랜',
    levelBenefitsTitle: '등급 혜택',
    tabOverview: '개요',
    tabSubscriptionPlan: '구독 플랜',
    tabSecurity: '보안',
    tabSettings: '알림 설정',
    ...
    tabInvite: '초대 리워드',
        ...
        giftCardRuleType3: '유형 3: 트래픽 추가 (value 단위: GB)',
        giftCardRuleType4: '유형 4: 트래픽 초기화',
        giftCardRuleType5: '유형 5: 요금제 즉시 개통 (value는 일수, 0은 무제한)',
        giftCardResultType1: '충전된 잔액: {value}',
        giftCardResultType2: '유효기간 {value}일 연장',
        giftCardResultType3: '트래픽 {value}GB 추가',
        giftCardResultType4: '트래픽이 초기화되었습니다',
        giftCardResultType5: '요금제 {value}일 개통',
        giftCardResultType5NoExpire: '무기한 요금제가 개통되었습니다',
    balanceDesc: '잔액 내역과 충전 기록 보기',
    orderHistory: '주문 내역',
    orderDesc: '과거 주문 및 결제 상태 보기',
    referral: '추천 리워드',
    referralDesc: '추천 진행 상황과 수수료 내역 보기',
    settingsTitle: '알림 설정',
    expireReminder: '만료 알림',
    expireReminderDesc: '구독 만료 전 이메일 알림 발송',
    trafficReminder: '트래픽 알림',
    trafficReminderDesc: '트래픽 부족 시 이메일 알림 발송',
    securitySettings: '보안 설정',
    securityDesc: '비밀번호 변경 및 계정 보안 옵션',
    securityCenterTitle: '보안 센터',
    loginRecords: '활성 세션',
    loginRecordsDesc: '현재 로그인된 기기와 세션을 관리합니다',
    recentLoginTitle: '최근 로그인 정보',
    recentLoginDesc: '최근 5회 로그인 성공 기록을 표시합니다',
    loadingRecentLogin: '최근 로그인 기록을 불러오는 중...',
    recentLoginEmpty: '최근 로그인 기록이 없습니다',
    deviceReset: '기기 재설정',
    deviceResetDesc: '기기 구성을 다시 생성하고 기존 구성의 영향을 제거합니다',
    sessionTitle: '세션 작업',
    sessionDesc: '현재 로그인 세션에서 로그아웃합니다. 나중에 다시 로그인할 수 있습니다.',
    logout: '로그아웃',
...
profile: {
    ...
    subscription: '구독 관리',
    resetSecurity: '구성 주소 재설정',
    resetSecurityTitle: '구성 주소 재설정',
    confirmReset: '재설정 확인',
    resetSecurityConfirm: '구성 주소를 재설정하시겠습니까? 현재 구성 주소는 무효화되며 계속 사용하려면 새 구성을 다시 추가해야 합니다.',
    resetSuccess: '초기화 성공',
    resetError: '초기화 실패',
    copySubscription: '구성 주소 복사',
    subscriptionCopied: '구성 주소가 클립보드에 복사되었습니다',
    ...
    logoutAllSessions: '모든 세션 로그아웃',
    loggingOutAllSessions: '모든 세션 로그아웃 중...',
    logoutAllSessionsSuccess: '모든 세션에서 로그아웃되었습니다',
    logoutAllSessionsError: '모든 세션 로그아웃에 실패했습니다',
    logoutDevice: '로그아웃',
    loggingOutDevice: '로그아웃 중...',
    logoutDeviceSuccess: '기기 세션이 로그아웃되었습니다',
    logoutDeviceError: '기기 세션 로그아웃에 실패했습니다',
  ...
  shop: {
    ...
    no_plans_found: '조건에 맞는 구독을 찾을 수 없습니다',
  ...
  order: {
    ...
    no_plan_selected: '구독을 선택하지 않음',
    plan_not_found: '구독이 존재하지 않음',
    failed_to_fetch_plan: '구독 정보 가져오기 실패',
    confirm_order_title: '주문 확인',
    confirm_purchase: '구매 확인'
  },
  payment: {
  ...
  docs: {
    ...
    noAccessPrompt: '현재 유효한 구독이 없습니다. 구독을 구매하면 이 영역의 콘텐츠를 볼 수 있습니다',
    loading: '문서 로딩 중...',
    retry: '재시도',
    clearSearch: '검색 지우기',
