...
export default {
  auth: {
    ...
    loginTooManyAttempts: '비밀번호 오류 횟수가 너무 많습니다. 잠시 후 다시 시도하세요',
    loginAccountSuspended: '계정이 정지되었습니다',
    ...
    inviteCode: '초대 코드',
    inviteCodePlaceholder: '초대 코드를 입력',
    inviteCodeRequired: '초대 코드는 비워둘 수 없습니다',
    agreeToTerms: '동의합니다',
    termsOfService: '서비스 약관',
    mustAgreeToTerms: '회원가입하려면 약관에 동의해야 합니다',
    emailPlaceholder: '이메일을 입력',
    emailPrefixPlaceholder: '이메일 접두사를 입력하세요',
    codePlaceholder: '인증 코드를 입력',
