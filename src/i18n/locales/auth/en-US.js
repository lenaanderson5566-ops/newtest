...
export default {
  auth: {
    ...
    forgotPasswordSubtitle: "We'll send a verification code to your email",
    ...
    loginTooManyAttempts: 'Too many failed attempts. Please try again later.',
    loginAccountSuspended: 'Your account has been suspended',
    ...
    sendCodeIfEmailRegistered: 'If registered, a code will be sent',
    popup: {
      close_btn: 'OK',
    ...
    captchaRequired: 'Complete CAPTCHA',
