...
export default {
  auth: {
    ...
    loginInvalidCredentials: 'ایمیل یا پسورد اشتباه است',
    loginTooManyAttempts: 'تعداد دفعات خطای پسورد بیش از حد مجاز است، لطفاً بعداً تلاش کنید',
    loginAccountSuspended: 'حساب شما مسدود شده است',
    ...
    sendCodeIfEmailRegistered: 'اگر ایمیل ثبت شده باشد، کد ارسال می‌شود',
    popup: {
      close_btn: 'باشه',
    ...
    agreeToTerms: 'با این موارد موافقم',
    termsOfService: 'شرایط خدمات',
    mustAgreeToTerms: 'برای ثبت‌نام باید با شرایط موافق باشید',
    emailPlaceholder: 'ایمیل را وارد کنید',
    emailPrefixPlaceholder: 'پیشوند ایمیل را وارد کنید',
    codePlaceholder: 'کد را وارد کنید',
    newPasswordPlaceholder: 'پسورد جدید',
    confirmPasswordPlaceholder: 'تایید پسورد جدید',
