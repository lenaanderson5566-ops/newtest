...
export default {
  auth: {
    ...
    registerSubtitle: 'Tạo tài khoản',
    ...
    loginInvalidCredentials: 'Email hoặc mật khẩu không chính xác',
    loginTooManyAttempts: 'Bạn đã nhập sai mật khẩu quá nhiều lần, vui lòng thử lại sau',
    loginAccountSuspended: 'Tài khoản của bạn đã bị khóa',
    ...
    sendCodeIfEmailRegistered: 'Nếu đã đăng ký, hệ thống sẽ gửi mã',
    popup: {
      close_btn: 'OK',
    ...
    mustAgreeToTerms: 'Vui lòng đồng ý Điều khoản để đăng ký',
    ...
    captchaRequired: 'Hoàn tất xác thực',
