...
export default {
  auth: {
    ...
    loginTooManyAttempts: 'Слишком много неверных попыток. Повторите позже',
    loginAccountSuspended: 'Ваш аккаунт заблокирован',
