...
export default {
  ...
  dashboard: {
    ...
    defaultUser: 'ユーザー',
    welcomeNewUser: 'こんにちは、{name}さん。ようこそ。',
    welcomeBackUser: 'こんにちは、{name}さん。お帰りなさい。',
    announcement: 'お知らせ',
    siteAnnouncement: 'サイトお知らせ',
    subscriptionInfo: 'サブスクリプション情報',
    planName: 'サブスクリプション名',
    expiryDate: '有効期限',
    planTraffic: 'サブスクリプション流量',
    ...
    usagePanel: '使用状況パネル',
    totalTrafficPackAndPackage: '合計トラフィック（サブスクリプション + パッケージ）',
    ...
    tierCurrentPoints: '現在の成長値: {points}',
    tierNextLevel: '次のランク: {tier}',
    tierNeedPoints: '次のランクまで: {points}',
    nextTierHint: '{tier} まであと {points} 成長値',
    resetHint: 'リセット日: {day}',
    resetTimeLabel: 'リセット時刻',
    purchaseTrafficPackage: '買い切りトラフィックパッケージを購入',
    used: '使用済み',
    todayTrafficTitle: '本日の通信量',
    todayTrafficUsed: '使用済み',
    todayTrafficUpload: 'アップロード',
    todayTrafficDownload: 'ダウンロード',
    total: '合計',
    remaining: '残り',
    ...
    none: 'なし',
    days: '日',
    noPlanPrompt: '有効なサブスクリプションがありません。サブスクリプションを購入してください',
    noPlanBadgePending: '支払い待ち',
    noPlanBadgeInactive: 'サービス未開通',
    noPlanTitlePending: '支払い完了後にサービスを有効化できます',
    noPlanTitleInactive: 'まずサブスクリプションを選択して支払いを完了してください',
    noPlanActionPending: '支払いを続行',
    noPlanActionInactive: '今すぐ注文',
    importSubscription: '設定を追加',
    purchasePlan: 'サブスクリプション購入',
    resetTraffic: '流量リセット',
    ...
    renewPlan: 'サブスクリプション更新',
    noPlanToRenew: '更新可能なサブスクリプションがありません',
    resetTrafficConfirm: '流量リセット確認',
    resetTrafficDesc: 'この操作は使用済み流量をリセットしますが、サブスクリプション期間は延長されません。続行しますか？',
    resetTrafficSuccess: '流量リセット注文作成成功',
    resetTrafficWarning: 'リセットは使用済み流量にのみ影響し、サブスクリプション有効期間は延長されません',
    ...
    trafficPackageSupplementHint: 'プラン上限を超えた通信量は、流量パッケージで補充できます。',
    ...
    planAction: {
      ...
      restoreNow: '今すぐ復旧',
      renewNow: '今すぐ更新',
      reselectPlan: 'サブスクリプションを再選択',
      renew: '更新'
    },
    
    importTitle: 'インポート方法選択',
    copySubscription: '設定アドレスをコピー',
    copySubscriptionDesc: '設定アドレスをクリップボードにコピー',
    scanQRCode: 'QRコードで設定を追加',
    scanQRCodeDesc: 'クライアントでQRコードを読み取り設定を追加',
    ...
    subscriptionCopied: '設定アドレスをクリップボードにコピーしました',
    copyFailed: 'コピー失敗。手動でコピーしてください',
    manualImportRequired: '自動インポートできません。設定アドレスを手動でコピーして追加してください',
    noSubscription: '利用可能な設定アドレスがありません',
    noClientsAvailable: 'このプラットフォームでは即時インポート方法がありません',
    clientNotInstalled: '対応クライアントが未インストールのため、設定アドレスをクリップボードにコピーしました'
  },
  platforms: {
    ios: 'iOS',
    android: 'Android',
  ...
  myCenter: {
    ...
    accountBalance: 'アカウント残高',
    financeTitle: '財務センター',
    subscriptionPlanTitle: 'サブスクリプションプラン',
    levelBenefitsTitle: 'ランク特典',
    tabOverview: '概要',
    tabSubscriptionPlan: 'サブスクリプションプラン',
    tabSecurity: 'セキュリティ',
    tabSettings: '通知設定',
    ...
    tabInvite: '招待報酬',
        ...
        giftCardRuleType3: 'タイプ3：通信量追加（value 単位：GB）',
        giftCardRuleType4: 'タイプ4：通信量リセット',
        giftCardRuleType5: 'タイプ5：プラン直接開通（value は日数、0 は無期限）',
        giftCardResultType1: '残高チャージ：{value}',
        giftCardResultType2: '{value}日延長しました',
        giftCardResultType3: '通信量を{value}GB追加しました',
        giftCardResultType4: '通信量をリセットしました',
        giftCardResultType5: '{value}日間のプランを開通しました',
        giftCardResultType5NoExpire: '無期限プランを開通しました',
    balanceDesc: '残高明細とチャージ履歴を確認',
    orderHistory: '注文履歴',
    orderDesc: '過去の注文と支払い状況を確認',
    referral: '招待還元',
    referralDesc: '招待進捗とコミッション明細を確認',
    settingsTitle: '通知設定',
    expireReminder: '期限リマインダー',
    expireReminderDesc: 'サブスク期限前にメールで通知',
    trafficReminder: '通信量リマインダー',
    trafficReminderDesc: '通信量不足時にメールで通知',
    securitySettings: 'セキュリティ設定',
    securityDesc: 'パスワード変更とセキュリティ設定',
    securityCenterTitle: 'セキュリティセンター',
    loginRecords: 'アクティブセッション',
    loginRecordsDesc: '現在ログイン中の端末とセッションを管理します',
    recentLoginTitle: '最近のログイン情報',
    recentLoginDesc: '直近5件のログイン成功履歴を表示します',
    loadingRecentLogin: '最近のログイン履歴を読み込み中...',
    recentLoginEmpty: '最近のログイン履歴はありません',
    deviceReset: 'デバイスリセット',
    deviceResetDesc: 'デバイス設定を再生成し、旧設定の影響をクリアします',
    sessionTitle: 'セッション操作',
    sessionDesc: '現在のログインセッションからサインアウトします。後で再ログインできます。',
    logout: 'ログアウト',
...
profile: {
    ...
    resetSecurity: '設定アドレスをリセット',
    resetSecurityTitle: '設定アドレスをリセット',
    confirmReset: 'リセットを確認',
    resetSecurityConfirm: '設定アドレスをリセットしますか？現在の設定アドレスは無効になり、継続利用には新しい設定を追加する必要があります。',
    resetSuccess: 'リセット成功',
    resetError: 'リセット失敗',
    copySubscription: '設定アドレスをコピー',
    subscriptionCopied: '設定アドレスをクリップボードにコピーしました',
    ...
    logoutAllSessions: 'すべてのセッションからログアウト',
    loggingOutAllSessions: 'すべてのセッションからログアウト中...',
    logoutAllSessionsSuccess: 'すべてのセッションからログアウトしました',
    logoutAllSessionsError: 'すべてのセッションのログアウトに失敗しました',
    logoutDevice: 'ログアウト',
    loggingOutDevice: 'ログアウト中...',
    logoutDeviceSuccess: 'デバイスのセッションをログアウトしました',
    logoutDeviceError: 'デバイスのセッションログアウトに失敗しました',
  ...
  shop: {
    ...
    no_plans_found: '条件に合うサブスクリプションが見つかりません',
  ...
  order: {
    ...
    order_failed: '注文作成失敗',
    no_plan_selected: 'サブスクリプション未選択',
    plan_not_found: 'サブスクリプションが存在しません',
    failed_to_fetch_plan: 'サブスクリプション情報取得失敗',
    confirm_order_title: '注文確認',
    confirm_purchase: '購入を確定'
  },
  payment: {
  ...
  docs: {
    ...
    noAccessPrompt: '現在有効なサブスクリプションがありません。サブスクリプションを購入すると本セクションの内容を閲覧できます',
    loading: 'ドキュメント読み込み中...',
    retry: '再試行',
    clearSearch: '検索クリア',
